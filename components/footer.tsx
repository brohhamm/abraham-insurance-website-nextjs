...
export function Footer() { return <footer className="footer"><div className="shell footer-grid">
  ...
  <div><h2>Explore</h2>{navigation.slice(0,4).map(([l,h]) => <Link key={h} href={h}>{l}</Link>)}<Link href="/about">Our Agency</Link><Link href="/yorba-linda-office">Yorba Linda Office</Link><Link href="/customer-service">Customer Service</Link></div>
