...
const photos = {
  ...
  "insurance-before-escrow": { src: "/images/downtown-la-torrey-pines-bank.webp", en: "Downtown Los Angeles business district near Torrey Pines Bank", es: "Distrito comercial del centro de Los Ángeles cerca de Torrey Pines Bank", portrait: true },
  ...
  "insurance-mortgage-escrow": { src: "/images/california-hillside-homes-palms.webp", en: "Southern California hillside homes framed by palm trees and landscaping", es: "Casas en una ladera del sur de California rodeadas de palmeras y jardines", portrait: false },
  ...
  "commercial-general-liability-limits": { src: "/images/saks-fifth-avenue-commercial-buildings.webp", en: "Saks Fifth Avenue and neighboring commercial buildings in a California city center", es: "Saks Fifth Avenue y edificios comerciales cercanos en el centro de una ciudad de California", portrait: true },
  ...
  "uninsured-underinsured-motorist-california": { src: "/images/riverside-parking-palms-mountain.webp", en: "Riverside County parking area with palm trees, offices, and a mountain backdrop", es: "Estacionamiento del Condado de Riverside con palmeras, oficinas y montañas al fondo", portrait: true },
  "comprehensive-collision-deductibles": { src: "/images/southern-california-palm-sunset.webp", en: "Cars traveling beneath palm trees at a Southern California sunset", es: "Automóviles circulando bajo palmeras durante un atardecer del sur de California", portrait: false },
} as const;
