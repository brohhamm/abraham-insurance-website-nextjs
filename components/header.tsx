  ...
  return <header className="site-header">
    ...
    <div className="shell nav-row">
      ...
      <nav id="main-navigation" className={open ? "nav-links open" : "nav-links"} aria-label={spanish ? "Navegación principal" : "Main navigation"}>
        ...
        <Link className="language-link" href={localizePath(pathname, spanish ? "en" : "es")} hrefLang={spanish ? "en-US" : "es-US"} lang={spanish ? "en" : "es"} aria-label={spanish ? "View this page in English" : "Ver esta página en español"} onClick={() => setOpen(false)}>{spanish ? "English" : "Español"}</Link>
