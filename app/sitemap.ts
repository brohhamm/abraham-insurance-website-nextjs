...
export default function sitemap(): MetadataRoute.Sitemap {
  const paths = ["", "/personal-insurance", "/business-insurance", "/carriers", "/wildfire-insurance", "/referral-partners", "/education", "/about", "/abel-duran", "/abraham-nunez-chavez", "/devan-wright", "/rosalia-elizabeth-gomez", "/moreno-valley-office", "/yorba-linda-office", "/customer-service", "/contact", "/privacy", "/terms"];
  const english = [
