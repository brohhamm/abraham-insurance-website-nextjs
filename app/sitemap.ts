...
export default function sitemap(): MetadataRoute.Sitemap {
  const paths = ["", "/personal-insurance", "/business-insurance", "/carriers", "/wildfire-insurance", "/referral-partners", "/education", "/about", "/abel-duran", "/devan-wright", "/yorba-linda-office", "/customer-service", "/contact", "/privacy", "/terms"];
  return [
