...
export const metadata: Metadata = { metadataBase: new URL(siteConfig.url), title: { default: "Abraham Nunez-Chavez | Southern California Insurance", template: "%s | Abraham Nunez-Chavez" }, description: "Clear personal, commercial, wildfire property, and escrow insurance agent and broker services across Southern California.", openGraph: { siteName: "Abraham Nunez-Chavez Insurance", locale: "en_US", title: "Your Southern California Insurance Agent/Broker", description: "Personal and business insurance agent and broker services for Southern California.", type: "website", url: siteConfig.url, images:[{url:"/og-insurance.svg",width:1200,height:630,alt:"Abraham Nunez-Chavez Insurance Agent and Broker"}] }, icons: { icon: "/favicon.svg" } };
