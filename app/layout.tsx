...
export const metadata: Metadata = { metadataBase: new URL(siteConfig.url), title: { default: "Abraham Nunez-Chavez | Southern California Insurance", template: "%s | Abraham Nunez-Chavez" }, description: "Clear personal, commercial, wildfire property, and escrow insurance agent and broker services across Southern California.", alternates: { canonical: "/" }, openGraph: { title: "Your Southern California Insurance Agent/Broker", description: "Personal and business insurance agent and broker services for Southern California.", type: "website", url: siteConfig.url, images:["/og-placeholder.svg"] }, icons: { icon: "/favicon.svg" } };
